...
import type { AdminPropertyListParams } from "@/admin/lib/api/admin-property.types";
import {
  getOrganizationProperty,
  listOrganizationProperties,
} from "@/admin/lib/api/requests/organization-property";
import { organizationPropertyKeys } from "@/admin/lib/api/query-keys/organization-property";
