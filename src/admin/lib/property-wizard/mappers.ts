...
import type {
  PropertyStatus,
  PropertyType,
} from "@/app/admin/(app)/property-management/property-management-data";
import type {
  AdminPropertyDetail,
  AdminPropertyListItem,
  PropertyApiStatus,
  PropertyApiType,
} from "@/admin/lib/api/admin-property.types";
import { sectionKeyToSegment } from "@/admin/lib/property-wizard/section-keys";
...
export function getWizardResumeHref(
  ...
  createListingBase = "/admin/create-listing",
): string {
  const listingKind =
