...
import type { WizardStepSegment } from "@/app/admin/(app)/create-listing/create-listing-wizard-data";
...
import type { SaveWizardDraftRequest } from "@/admin/lib/api/admin-property.types";
import {
  useScopedCreatePropertyDraftMutation,
  useScopedProperty,
  useScopedSavePropertyDraftMutation,
} from "@/admin/lib/property-wizard/use-scoped-property-api";
import { isPropertyEditable } from "@/admin/lib/property-wizard/mappers";
