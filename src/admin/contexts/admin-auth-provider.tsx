...
import type { AdminLoginRequest, AdminUser } from "@/admin/lib/api/admin-auth.types";
import { adminLogin, adminLogout, getCurrentAdmin, getPostAuthRedirectPath, refreshAdminSession } from "@/admin/lib/api/admin-auth";
...
export function AdminAuthProvider({ children }: { children: ReactNode }) {
  ...
  const logout = useCallback(async () => {
    ...
    setAdmin(null);
    try { await adminLogout(); } finally { router.replace("/admin/sign-in"); }
  }, [router]);
