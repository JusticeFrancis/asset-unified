...
import { GovernanceProposal, GovernanceVote, Property } from "@/admin/models";
import { requireAdmin } from "@/admin/lib/server/auth";
import { connectDb } from "@/admin/lib/server/db";
import { handleRouteError, HttpError, ok, positiveInt, readJson } from "@/admin/lib/server/http";
import { proposalJson } from "@/admin/lib/server/common-serializers";
import { recordActivity } from "@/admin/lib/server/activity";
import { syncGovernanceProposalToClientRecord } from "@/admin/lib/server/client-record-sync";
