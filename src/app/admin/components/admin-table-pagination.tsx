...
/** 0-based page indices for compact pagination (matches `/admin/rent-submission`). */
...
/**
 * Footer pagination bar aligned with `/admin/rent-submission` (layout, chevrons, page pills).
 */
