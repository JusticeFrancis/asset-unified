...
const tabs = [
  { label: "Account", href: "/admin/settings/account-information", permission: "settings.view" },
  { label: "Security & Privacy", href: "/admin/settings", permission: "settings.view" },
  { label: "Platform Fee", href: "/admin/settings/platform-fee", permission: "platform_settings.view" },
] as const;
