...
import { GovernanceVoteConfirmModal } from "@/app/admin/(app)/governance/components/governance-vote-confirm-modal";
import type {
  GovernanceProposalRecord,
  GovernanceVoteChoice,
} from "@/app/admin/(app)/governance/data/governance-records";
