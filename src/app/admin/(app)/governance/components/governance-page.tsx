...
import { GovernanceProposalRow } from "@/app/admin/(app)/governance/components/governance-proposal-row";
import { GovernanceStatsBanner } from "@/app/admin/(app)/governance/components/governance-stats-banner";
import { getGovernanceProposals } from "@/app/admin/(app)/governance/data/governance-records";
