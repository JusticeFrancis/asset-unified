    ...
    <Card className="w-full min-w-0 rounded-[20px] border-0 bg-white shadow-sm">
      <CardContent className="flex flex-col gap-4 p-4 sm:p-6">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          {canCreate ? (
            <Link
              href="/admin/roles-and-permissions/add-admin-user"
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex justify-center gap-2">
                          <Link
                            href={`/admin/roles-and-permissions/view-admin-user?id=${item.id}`}
                          ...
                          {canUpdate && canManageTarget ? (
                            <Link
                              href={`/admin/roles-and-permissions/edit-admin-user?id=${item.id}`}
                              className="rounded-lg bg-[#edf4f8] px-3 py-2"
                            >
                              Edit
                            </Link>
