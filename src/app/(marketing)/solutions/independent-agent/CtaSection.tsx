import {
  IndependentAgentCtaChatIllustration,
  IndependentAgentCtaFreeConsultationIcon,
} from "@/lib/assets";
...
export function CtaSection() {
  return (
    <SolutionsConsultationCta
      ...
      buttonIcon={IndependentAgentCtaFreeConsultationIcon}
      illustration={IndependentAgentCtaChatIllustration}
    />
  );
}
