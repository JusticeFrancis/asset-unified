...
import { independentAgentBenefits } from "./data";
      ...
      <Container className="max-w-[1240px]">
        <div className="max-w-[778px]">
          <h2 className="text-h1 font-medium leading-tight text-foreground">
            ...
            <span className="text-brand">in real estate to qualify</span>
          </h2>
          <p className="mt-4 max-w-[622px] text-base leading-relaxed text-[#2C373F] sm:text-body-lg">
            Anyone who has a professional network of people who invest - or who
            might - can be a successful Asset Union independent agent.
            Here&apos;s who we work best with.
          </p>
        </div>

        <div className="mt-10 grid gap-5 sm:mt-12 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3 lg:gap-[25px]">
          {independentAgentBenefits.map((benefit) => (
            <article
              key={benefit.title}
            ...
            >
              ...
              <h3 className="mt-3 text-h3 font-medium leading-tight text-foreground">
                {benefit.title}
              </h3>
