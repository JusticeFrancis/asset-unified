...
import type { GovernanceVoteChoice } from "@/app/dashboard/governance/data/governance-records";
        ...
        <div className="flex flex-col items-center gap-6">
          <div className="relative size-[71px] shrink-0">
            <img
              ...
              src={DASHBOARD_ASSETS.governance.voteConfirmHeader}
            />
          </div>
          ...
          {error ? <p className="w-full text-center text-[12px] font-medium text-red-600">{error}</p> : null}
            ...
            <button
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  setError(cause instanceof Error ? cause.message : "The vote could not be recorded.");
                } finally {
                  setSubmitting(false);
                }
              }}
