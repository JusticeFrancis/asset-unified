...
export function GovernanceStatsBanner({
  ...
  return (
    <div className="flex min-h-[123px] w-full flex-col gap-4 rounded-[16px] bg-[#dcddf4] px-4 py-5 sm:gap-6 sm:px-12 sm:py-6 lg:flex-row lg:items-center lg:justify-between lg:gap-0">
      <StatColumn
